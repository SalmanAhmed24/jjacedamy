	...
	return (
		<div>
			...
			<div className="otherParas">
				...
				<p>
					On August 14th, 2020, an online international branch of Shaheed Junaid Jamshed Academy was also
					established in California, USA,Alhamdulillah.
				</p>
				<p>
					Apart from this Online Platform, we have two beautiful campuses in Islamabad and Bahria Rawalpindi.
					Hundreds of students of all ages have completed their studies of Deen from here and many many more
					are still enrolled.
				</p>
				...
				<p>
					...
					song, “Dil Dil Pakistan” is said to be Pakistan’s second national anthem. In 2003, in BBC’s World
					Service online poll of about 7000 popular songs from all over the world, “Dil Dil Pakistan” came
					third. And then at the height of his career, he gave it up to devote his life to Allah and to spread
					HIS message throughout the whole world, and eventually, his spiritual journey also ended in this
					path. He had lived a full life with spiritual grace and departed to the hereafter with that same
					grace. He had been in the path of Allah in Chitral, and on his way back, he achieved
					shahadah(martyrdom) in the path of Allah too. He was 52.
				</p>
				<p>
					Junaid Jamshed’s efforts in the work of dawah are renowned. He emphasized his mission for the unity
					of the Muslim Ummah and the significant role of dawah, which helped him to completely alter his life
					from a pop star to a devoted servant of Islam. His qualities of forgiveness, patience, and
					confidence also played significant role in motivating Muslims living throughout the world.
				</p>
				<p>
					He was an icon for the public and a role model within his family. Everyone looked up to him. That's
					why he turned to religion. To seek the greater good. Even in his new incarnation, Junaid Jamshed was
				...
				<p>
					...
					Pakistan’s largest human shadow, who was brave enough to experiment, struggle and came out stronger
					than ever. There will never be another Junaid.
				</p>
				<h1 className="subHead2">
					ABOUT <span className="span-head">MUNIZA JAVED KHAN(FOUNDER)</span>
				</h1>
				<p>
					Shaheed Junaid Jamshed's younger sister Muniza Javed continues her brother's legacy of dawah. She
